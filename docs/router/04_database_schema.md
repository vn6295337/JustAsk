...
**Source:** Populated by justask-registry pipeline (daily updates)
...
When justask-registry adds new models to working_version:
...
- working_version: 50+ models (text-generation)
