...
- **Daily updates:** Automatic refresh from justask-registry pipeline
...
- Real-time model selection from daily-updated database (50+ models)
...
- Seamless integration with justask/api backend
...
**Integration points:**
- `justask/api/src/routing/router.js` - Primary selection
- `justask/api/src/failover/failover.js` - Uses dynamic model names
- `justask/api/src/utils/modelSelectorClient.js` - HTTP client
...
- justask/api backend integrated on port 3000
- 50+ models cached from Supabase
